...
const String _callbackFailedAttempt = 'on_fail_attempt';
...
class LocalAuthentication {
  ...
  Future<bool> authenticateWithBiometrics({
    ...
    VoidCallback onAuthenticationFailedAttempt,
  }) async {
    assert(localizedReason != null);
    _waitCallbacks(
      onAuthenticationFailedAttempt: onAuthenticationFailedAttempt,
    );
  ...
  void _waitCallbacks({
    ...
    _channel.setMethodCallHandler(
          (call) {
        if (call.method == _callbackFailedAttempt) {
          onAuthenticationFailedAttempt?.call();
        }
      },
    );
  }
