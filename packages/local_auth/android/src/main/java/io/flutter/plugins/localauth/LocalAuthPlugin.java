...
public class LocalAuthPlugin implements MethodCallHandler, FlutterPlugin, ActivityAware {
  ...
  private static final String ON_FAIL_ATTEMPT = "on_fail_attempt";
  ...
  public static void registerWith(io.flutter.plugin.common.PluginRegistry.Registrar registrar) {
    ...
    channel.setMethodCallHandler(new LocalAuthPlugin(registrar.activity(), channel));
  }

  private LocalAuthPlugin(Activity activity, MethodChannel channel) {
      ...
      authenticationHelper =
          new AuthenticationHelper(
              ...
              new AuthCompletionHandler() {
                ...
                @Override
                public void onFailAttempt() {
                  channel.invokeMethod(ON_FAIL_ATTEMPT, new HashMap<Integer, Integer>());
                }
              });
